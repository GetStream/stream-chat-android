...
public object PreviewChannelData {
    public val channelWithImage: Channel =
        Channel(
            type = "channelType",
            id = "channelId1",
    ...
    public val channelWithOneUser: Channel =
        Channel(
            type = "channelType",
            id = "channelId2",
            members =
    ...
    public val channelWithOnlineUser: Channel =
        Channel(
            type = "channelType",
            id = "channelId3",
            members =
    ...
    public val channelWithFewMembers: Channel =
        Channel(
            type = "channelType",
            id = "channelId4",
            members =
    ...
    public val channelWithManyMembers: Channel =
        Channel(
            type = "channelType",
            id = "channelId5",
            members =
    ...
    public val channelWithMessages: Channel =
        Channel(
            type = "channelType",
            id = "channelId6",
            members =
