...
- 🚨 Breaking change: Markdown support is moved into a standalone module `stream-chat-android-markdown-transformer`.
...
- `ChatUI.markdown` is deprecated in favour of `ChatMessageTextTransformer`.
