...
- Added method to consult the settings of the app. Use `ChatClient.instance().appSettings().enqueue` to request the settings of your app. [#2960](https://github.com/GetStream/stream-chat-android/pull/2960)
