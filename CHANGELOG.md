...
- Added in the ClientState.initializationState. Now you can check when the current state of the intialization progress. [#3962](https://github.com/GetStream/stream-chat-android/pull/3962)
