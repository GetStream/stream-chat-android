...
public class ChatClientReferenceAdapter(private val chatClient: ChatClient) {
    ...
    public fun queryChannel(channelType: String, channelId: String, request: QueryChannelRequest): QueryChannelReference = QueryChannelReference(channelType, channelId, request, chatClient)
}
