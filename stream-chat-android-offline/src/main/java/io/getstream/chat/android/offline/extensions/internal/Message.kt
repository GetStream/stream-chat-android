 ...
 * @param ignoreMutesForUnreadCount If we should ignore muted channel state when updating the unread count.
 */
internal fun Message.shouldIncrementUnreadCount(
    ...
    if (isChannelMuted && !ignoreMutesForUnreadCount) return false
