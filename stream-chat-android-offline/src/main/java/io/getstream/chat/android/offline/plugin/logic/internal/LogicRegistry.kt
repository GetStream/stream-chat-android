...
internal class LogicRegistry internal constructor(
    ...
    private val queryChannels: ConcurrentHashMap<Pair<FilterObject, IQuerySort<Channel>>, QueryChannelsLogic> =
        ConcurrentHashMap()
    ...
    fun queryChannels(filter: FilterObject, sort: IQuerySort<Channel>): QueryChannelsLogic {
