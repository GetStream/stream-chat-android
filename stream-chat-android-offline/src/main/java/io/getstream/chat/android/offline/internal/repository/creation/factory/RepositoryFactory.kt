package io.getstream.chat.android.offline.internal.repository.creation.factory
...
import io.getstream.chat.android.offline.internal.repository.domain.channel.ChannelRepositoryImpl
import io.getstream.chat.android.offline.internal.repository.domain.channelconfig.ChannelConfigRepository
import io.getstream.chat.android.offline.internal.repository.domain.channelconfig.ChannelConfigRepositoryImpl
import io.getstream.chat.android.offline.internal.repository.domain.message.MessageRepository
import io.getstream.chat.android.offline.internal.repository.domain.message.MessageRepositoryImpl
import io.getstream.chat.android.offline.internal.repository.domain.message.attachment.AttachmentRepository
import io.getstream.chat.android.offline.internal.repository.domain.message.attachment.AttachmentRepositoryImpl
import io.getstream.chat.android.offline.internal.repository.domain.queryChannels.QueryChannelsRepository
import io.getstream.chat.android.offline.internal.repository.domain.queryChannels.QueryChannelsRepositoryImpl
import io.getstream.chat.android.offline.internal.repository.domain.reaction.ReactionRepository
import io.getstream.chat.android.offline.internal.repository.domain.reaction.ReactionRepositoryImpl
import io.getstream.chat.android.offline.internal.repository.domain.syncState.SyncStateRepository
import io.getstream.chat.android.offline.internal.repository.domain.syncState.SyncStateRepositoryImpl
import io.getstream.chat.android.offline.internal.repository.domain.user.UserRepository
import io.getstream.chat.android.offline.internal.repository.domain.user.UserRepositoryImpl
