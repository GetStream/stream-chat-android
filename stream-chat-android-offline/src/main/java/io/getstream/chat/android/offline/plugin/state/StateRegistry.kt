...
public class StateRegistry private constructor(
    ...
    private val queryChannels: ConcurrentHashMap<Pair<FilterObject, IQuerySort<Channel>>, QueryChannelsMutableState> =
        ConcurrentHashMap()
     ...
     */
    public fun queryChannels(filter: FilterObject, sort: IQuerySort<Channel>): QueryChannelsState {
