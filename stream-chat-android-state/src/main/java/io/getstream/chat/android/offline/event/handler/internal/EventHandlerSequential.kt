...
import io.getstream.chat.android.client.extensions.internal.mergeChannelFromEvent
...
internal class EventHandlerSequential(
    ...
    private suspend fun updateGlobalState(batchEvent: BatchEvent) {
        ...
        var me = mutableGlobalState.clientState.user.value
            ...
            when (event) {
                ...
                is NewMessageEvent -> {
                    ...
                    val channel = batch.getCurrentChannel(event.cid)
                        ?: repos.selectChannelWithoutMessages(event.cid)
                        ?: continue
