...
internal class QueryChannelsListenerStateTest {
    ...
    @Test
    fun `onQueryChannelsResultWithPredefinedFilter applies resolved spec when predefinedFilter is present`() = runTest {
        // Given
    ...
    @Test
    fun `onQueryChannelsResultWithPredefinedFilter applies default sort when predefinedFilter has null sort`() =
        runTest {
            // Given
            val request = QueryChannelsRequest(
                limit = 30,
    ...
    @Test
    fun `onQueryChannelsResultWithPredefinedFilter does not apply resolved spec for plain success without predefinedFilter`() =
        runTest {
            // Given
            val request = QueryChannelsRequest(
    ...
    @Test
    fun `onQueryChannelsResultWithPredefinedFilter forwards channels to the logic and frees the channel-querying flag`() =
        runTest {
            // Given
