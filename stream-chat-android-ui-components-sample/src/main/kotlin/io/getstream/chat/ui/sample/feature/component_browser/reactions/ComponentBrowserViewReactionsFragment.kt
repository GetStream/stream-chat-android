...
class ComponentBrowserViewReactionsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            reactionsView3.setMessage(randomMessage(reactionsSize = 3, ownReactionsSize = 1), isMyMessage = true)
            reactionsView4.setMessage(randomMessage(reactionsSize = 3, ownReactionsSize = 1), isMyMessage = false)
            reactionsView5.setMessage(randomMessage(reactionsSize = 1, ownReactionsSize = 0), isMyMessage = true)
            reactionsView6.setMessage(randomMessage(reactionsSize = 1, ownReactionsSize = 0), isMyMessage = false)
        }
    }
}
