...
| --- | --- | --- | --- | --- |
| Old serialization implementation<br/>*client* | 2021.05.10 | 2021.07.10 ⌛ | 2021.09.10 ⌛ | See the [4.10.0 release notes](https://github.com/GetStream/stream-chat-android/releases/tag/4.10.0) for details |
...
| `MessageInputView#setSuggestionListView` <br/>*ui-components* | 2021.04.13 | 2021.04.27<br/>4.10.0 | 2021.05.25 ⌛ | Setting external SuggestionListView is no longer necessary |
