...
| --- | --- | --- | --- | --- |
| `DeletedMessageListItemPredicate` | 2022.04.28<br/>5.0.4 | 2022.05.10 ⌛ | 2022.06.07 ⌛ | Use `DeletedMessageVisibility` in conjunction with `MessageListViewModel.setDeletedMessagesVisibility` instead. |
