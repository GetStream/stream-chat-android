...
internal object PollTestData {
    ...
    val expectedAllFields = Poll(
        ...
        votes = listOf(
            Vote(
                ...
                user = User(id = "user1", role = "user", invisible = false, banned = false, online = true, createdAt = Date(1577836800000L), updatedAt = Date(1577836800000L)),
            ),
            Vote(
                id = "vote2",
                pollId = "poll1",
                ...
                createdAt = Date(1704103200000L),
                updatedAt = Date(1704106800000L),
                user = User(id = "user2", role = "user", invisible = false, banned = false, online = true, createdAt = Date(1577836800000L), updatedAt = Date(1577836800000L)),
            ),
        ),
        ownVotes = listOf(
            Vote(
        ...
        answers = listOf(
            Answer(
                ...
                createdAt = Date(1704103200000L),
                updatedAt = Date(1704106800000L),
                user = User(id = "user3", role = "user", invisible = false, banned = false, online = true, createdAt = Date(1577836800000L), updatedAt = Date(1577836800000L)),
            ),
        ),
        createdBy = User(id = "admin", role = "admin", invisible = false, banned = false, online = true, createdAt = Date(1577836800000L), updatedAt = Date(1577836800000L)),
        extraData = emptyMap(),
    )
    ...
    val jsonWithExplicitNulls =
        """{"id":"poll1","name":"Favorite color","description":"Choose your favorite color","options":[{"id":"option1","text":"Red"}],"voting_visibility":"public","enforce_unique_vote":true,"allow_user_suggested_options":false,"allow_answers":false,"vote_count":0,"own_votes":[],"created_at":"2024-01-01T09:00:00.000Z","updated_at":"2024-01-01T12:00:00.000Z","answers_count":0,"created_by_id":"admin","max_votes_allowed":null,"is_closed":null}"""
