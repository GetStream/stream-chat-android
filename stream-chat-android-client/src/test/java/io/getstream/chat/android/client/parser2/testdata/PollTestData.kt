    ...
    val expectedAllFields = Poll(
        ...
        votes = listOf(
            Vote(
                ...
                user = User(id = "user1", role = "user", invisible = null, banned = false, online = true),
            ),
            Vote(
                id = "vote2",
                pollId = "poll1",
                ...
                createdAt = Date(1704103200000L),
                updatedAt = Date(1704106800000L),
                user = User(id = "user2", role = "user", invisible = null, banned = false, online = true),
            ),
        ),
        ownVotes = listOf(
            Vote(
        ...
        answers = listOf(
            Answer(
                ...
                createdAt = Date(1704103200000L),
                updatedAt = Date(1704106800000L),
                user = User(id = "user3", role = "user", invisible = null, banned = false, online = true),
            ),
        ),
