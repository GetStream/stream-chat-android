...
import io.getstream.chat.android.client.randomMessage
...
internal class WhenUploadAttachmentsTests {
    ...
    fun `Given exception when upload Should insert message with failed sync status to repo`() = runTest {
        ...
        val sut =
            Fixture().givenAttachmentUploader(attachmentUploader).givenMessageRepository(repository).givenMessage(message)
                .get()
    ...
    private class Fixture {
        ...
        private var logicRegistry: ChannelsManager = mock {
