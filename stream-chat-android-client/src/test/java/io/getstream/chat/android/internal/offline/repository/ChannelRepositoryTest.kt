...
import io.getstream.chat.android.internal.offline.integration.BaseDomainTest2
...
internal class ChannelRepositoryTest : BaseDomainTest2() {
    ...
    @Test
    fun `deleteAllChannelUserMessages should remove all messages from specific user in specific channel`(): Unit =
        runTest {
    ...
    @Test
    fun `deleteAllChannelUserMessages should remove pinned messages from specific user in specific channel`(): Unit =
        runTest {
    ...
    @Test
    fun `deleteAllChannelUserMessages with null cid should remove all messages from user across all channels`(): Unit =
        runTest {
