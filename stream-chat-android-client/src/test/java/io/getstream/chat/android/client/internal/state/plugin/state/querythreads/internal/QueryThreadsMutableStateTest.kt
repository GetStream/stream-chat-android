...
package io.getstream.chat.android.client.internal.state.plugin.state.querythreads.internal
...
internal class QueryThreadsMutableStateTest {
    ...
    private val threadList1 = listOf(
        Thread(
            ...
            threadParticipants = listOf(
                randomThreadParticipant(user = User("usrId1")),
                randomThreadParticipant(user = User("usrId2")),
            ),
            lastMessageAt = Date(),
            createdAt = Date(),
            updatedAt = Date(),
    ...
    private val mutableState = QueryThreadsMutableState(
        filter = null,
        sort = QueryThreadsRequest.DefaultSort,
    )
