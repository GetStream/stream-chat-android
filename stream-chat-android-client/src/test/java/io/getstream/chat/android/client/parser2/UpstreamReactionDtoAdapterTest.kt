...
internal class UpstreamReactionDtoAdapterTest {
    ...
    fun `Serialize JSON reaction with custom fields`() {
        ...
        Assertions.assertThat(jsonString).isEqualTo(ReactionDtoTestData.upstreamJson)
    }
    ...
    fun `Serialize JSON reaction without custom fields`() {
        ...
        Assertions.assertThat(jsonString).isEqualTo(ReactionDtoTestData.upstreamJsonWithoutExtraData)
    }
