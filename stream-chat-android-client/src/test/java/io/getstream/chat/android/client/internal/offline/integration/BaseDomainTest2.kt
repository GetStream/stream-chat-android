...
package io.getstream.chat.android.client.internal.offline.integration
...
internal open class BaseDomainTest2 : SynchronizedCoroutineTest {
    ...
    private fun createClientMock(isConnected: Boolean = true): ChatClient {
        ...
        val queryChannelsInternalResult = Result.Success(
            QueryChannelsResult(channels = listOf(data.channel1), predefinedFilter = null),
        )
        ...
        val client = mock<ChatClient> {
            ...
            on { queryChannelsInternal(any()) } doReturn TestCall(queryChannelsInternalResult)
