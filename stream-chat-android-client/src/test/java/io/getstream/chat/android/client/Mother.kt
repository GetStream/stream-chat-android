...
internal object Mother {
    ...
    internal fun randomMessage(
        ...
        html: String = io.getstream.chat.android.test.randomString(),
        ...
        replyMessageId: String? = io.getstream.chat.android.test.randomString(),
    ...
    private fun randomSyncStatus(exclude: List<SyncStatus> = emptyList()): SyncStatus =
        (SyncStatus.values().asList() - exclude - SyncStatus.AWAITING_ATTACHMENTS).random()

    internal fun randomChannelInfo(
        cid: String? = io.getstream.chat.android.test.randomString(),
        id: String? = io.getstream.chat.android.test.randomString(),
        type: String = io.getstream.chat.android.test.randomString(),
