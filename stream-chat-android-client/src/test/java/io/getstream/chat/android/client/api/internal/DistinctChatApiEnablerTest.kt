...
internal class DistinctChatApiEnablerTest {
    ...
    private val aroundId = randomString()
    ...
    fun testDistinctApiEnabled() {
        ...
        enabler.getRepliesAround(parentId, aroundId, limit)
        ...
        verify(distinctApi, times(1)).getRepliesAround(parentId, aroundId, limit)
    ...
    fun testDistinctApiDisabled() {
        ...
        verify(api, times(1)).getRepliesAround(parentId, aroundId, limit)
