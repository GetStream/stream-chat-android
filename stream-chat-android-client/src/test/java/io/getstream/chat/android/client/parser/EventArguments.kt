...
internal object EventArguments {
    ...
    private val notificationInviteRejectedEvent = NotificationInviteRejectedEvent(EventType.NOTIFICATION_INVITE_REJECTED, date, cid, channelType, channelId, user, member)
