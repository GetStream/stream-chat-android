...
internal class ChannelEventHandlerLegacyImpl(
     ...
     *
     * @param event The [io.getstream.chat.android.client.events.ChatEvent] to handle.
     */
    ...
    private fun handleCidEvent(event: CidEvent) {
        when (event) {
            ...
            is NewMessageEvent -> {
                ...
                // Update channel read state. Must happen before the message is upserted: a message
                // already present in the state does not update the unread count.
