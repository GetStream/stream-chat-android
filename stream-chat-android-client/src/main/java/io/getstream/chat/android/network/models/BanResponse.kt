...
internal data class BanResponse(
    @Json(name = "created_at")
    internal val createdAt: java.util.Date,

    @Json(name = "expires")
    internal val expires: java.util.Date? = null,

    @Json(name = "reason")
    internal val reason: String? = null,

    @Json(name = "shadow")
    internal val shadow: Boolean? = null,

    @Json(name = "banned_by")
    internal val bannedBy: io.getstream.chat.android.network.models.UserResponse? = null,
