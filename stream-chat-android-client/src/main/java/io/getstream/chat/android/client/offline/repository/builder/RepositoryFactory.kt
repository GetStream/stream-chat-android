...
import io.getstream.chat.android.client.offline.repository.domain.channel.ChannelRepository
import io.getstream.chat.android.client.offline.repository.domain.channel.ChannelRepositoryImpl
import io.getstream.chat.android.client.offline.repository.domain.channelconfig.ChannelConfigRepository
import io.getstream.chat.android.client.offline.repository.domain.channelconfig.ChannelConfigRepositoryImpl
...
import io.getstream.chat.android.client.offline.repository.domain.message.attachment.AttachmentRepository
import io.getstream.chat.android.client.offline.repository.domain.message.attachment.AttachmentRepositoryImpl
import io.getstream.chat.android.client.offline.repository.domain.queryChannels.QueryChannelsRepository
import io.getstream.chat.android.client.offline.repository.domain.queryChannels.QueryChannelsRepositoryImpl
import io.getstream.chat.android.client.offline.repository.domain.reaction.ReactionRepository
import io.getstream.chat.android.client.offline.repository.domain.reaction.ReactionRepositoryImpl
import io.getstream.chat.android.client.offline.repository.domain.syncState.SyncStateRepository
import io.getstream.chat.android.client.offline.repository.domain.syncState.SyncStateRepositoryImpl
