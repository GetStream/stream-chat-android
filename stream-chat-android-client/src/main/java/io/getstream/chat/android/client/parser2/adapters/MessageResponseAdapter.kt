...
// Downstream (read-only) adapter for the generated MessageResponse: collects root-level custom fields
// into `custom`, matching the wire's flattened extra data.
internal object MessageResponseAdapter :
    CustomObjectDtoAdapter<MessageResponse>(
