...
internal data class MessageResponse(
    ...
    @Json(name = "mentioned_channel_members")
    internal val mentionedChannelMembers: Map<String, io.getstream.chat.android.network.models.ChannelMemberPartialResponse>? = emptyMap(),
