...
package io.getstream.chat.android.internal.offline.plugin.factory
...
import io.getstream.chat.android.internal.offline.plugin.internal.OfflinePlugin
import io.getstream.chat.android.internal.offline.plugin.listener.internal.CreateChannelListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.DeleteChannelListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.DeleteMessageForMeListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.DeleteMessageListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.DeleteReactionListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.DraftMessageListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.EditMessageListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.FetchCurrentUserListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.GetMessageListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.HideChannelListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.QueryChannelListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.QueryMembersListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.QueryThreadsListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.SendAttachmentsListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.SendMessageListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.SendReactionListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.ShuffleGiphyListenerDatabase
import io.getstream.chat.android.internal.offline.plugin.listener.internal.ThreadQueryListenerDatabase
import io.getstream.chat.android.internal.offline.repository.database.database.internal.ChatDatabase
import io.getstream.chat.android.internal.offline.repository.factory.internal.DatabaseRepositoryFactory
...
internal class StreamOfflinePluginFactory @JvmOverloads constructor(
    ...
    private fun createOfflinePlugin(user: User): OfflinePlugin {
        ...
        val deleteMessageForMeListener = DeleteMessageForMeListenerDatabase(
            clientState = clientState,
            messageRepository = repositoryFacade,
        )
        ...
        return OfflinePlugin(
            ...
            deleteMessageForMeListener = deleteMessageForMeListener,
