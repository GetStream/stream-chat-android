...
/**
 * Retrofit API interface for managing push notification preferences.
 */
@AuthenticatedApi
internal interface PushPreferencesApi {

    /**
     * Upserts push notification preferences for the user.
     *
