...
You can translate all [verbals](https://github.com/GetStream/stream-chat-android/blob/master/library/src/main/res/values/strings.xml) of SDK in your application on based [Localize the UI with Translations Editor](https://developer.android.com/studio/write/translations-editor).<br/>
