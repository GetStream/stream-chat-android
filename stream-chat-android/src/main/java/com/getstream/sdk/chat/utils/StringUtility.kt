...
internal object StringUtility {
    ...
    @JvmStatic
    fun getDeletedOrMentionedText(message: Message): String {
        // Trimming New Lines
        var text = message.text.replace("^[\r\n]+|[\r\n]+$".toRegex(), "")

        if (message.deletedAt != null) {
            text = "_" + Chat.instance().strings.get(R.string.stream_delete_message) + "_"
            return text
        }
    ...
    @JvmStatic
    fun convertVideoLength(videoLength: Long): String {
    ...
    @JvmStatic
    fun convertFileSizeByteCount(bytes: Long): String {
        val unit = 1000
    ...
    @JvmStatic
    fun convertMentionedText(text: String, userName: String): String {
