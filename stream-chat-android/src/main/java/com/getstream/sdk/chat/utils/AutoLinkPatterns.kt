...
/**
 * It has WEB_URL pattern for autolink. It can be used to support other patterns
 * like Phone Number, Email and Geolocation.
 *
 * These patterns are adopted from [android.util.Patterns] because the internal AUTOLINK_WEB_URL is not accessible.
 */
internal object AutoLinkPatterns {
    ...
    private val DOMAIN_NAME: Pattern = Pattern.compile("($HOST_NAME|$IP_ADDRESS)")
