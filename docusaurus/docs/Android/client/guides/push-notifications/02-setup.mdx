...
:::info
The SDK supports multiple languages. Make sure to override resources in all languages used in your app. Refer to [Adding Localization](../../../ui/guides/custom-translations.mdx) guide for more details.
:::
...
Our [`MessageListView`](../../../ui/message-components/message-list.mdx) UI component and [`MessageList`](../../../compose/message-components/message-list.mdx) Compose UI Component automatically dismiss notifications related to a `Channel` when the user opens it.
