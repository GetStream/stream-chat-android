...
In case you prefer a diferent configuration for `MessageInputView`, you can select the direction of text using `MessageInputView.setInputTextDirection`. Example:
