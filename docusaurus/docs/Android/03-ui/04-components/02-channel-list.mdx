...
We also provide the `BaseChatEventHandler` implementation. It's an abstract incomplete implementation that covers the most generic cases and forces you to implement the required ones.
