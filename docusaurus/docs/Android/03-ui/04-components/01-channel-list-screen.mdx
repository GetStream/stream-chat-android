...
* [`SearchInputView`](10-search-view.mdx): An input field to search for messages that contain specific text.
* [`SearchResultListView`](10-search-view.mdx): Displays a list of search result items.
