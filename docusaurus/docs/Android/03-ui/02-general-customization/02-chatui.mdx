...
Here's an example of a custom factory that extends `AvatarBitmapFactory`, which makes the avatar for offline users to shades of gray:
...
![Shades of gray images for offline users](../../assets/blurred_images.png)
