...
**If you only would like  to change the gradient colors for the avatar**, you can use `stream_ui_avatar_gradient_colors`. You can override this color in your color xml file like: 
