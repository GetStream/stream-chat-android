...
The normal color set include a variaty of colors: 

![Colorful avatars](../assets/colorful_avatars.png)

You can override this color in your color xml file. And expand of reduce the number of supported color, like the example
