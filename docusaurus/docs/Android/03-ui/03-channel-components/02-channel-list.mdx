...
:::note
You may need to pass a custom `ChatEventHandler` to make sure the list is updated properly. Check [ChannelListUpdates](../../02-client/06-guides/05-channel-list-updates.mdx) section to read more.
:::
...
<androidx.constraintlayout.widget.ConstraintLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <io.getstream.chat.android.ui.avatar.ChannelAvatarView
