...
:::note
You may need to pass a custom `ChatEventHandler` to make sure the list is updated properly. Check [ChannelListUpdates](../../02-client/06-guides/03-channel-list-updates.mdx) section to read more.
:::
