...
To use the channel list screen, you can simply start `ChannelListActivity` from the SDK:
...
Alternatively, you can achieve the same result by adding `ChannelListFragment` from the SDK to your Activity:
