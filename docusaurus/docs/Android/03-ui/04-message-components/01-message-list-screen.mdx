...
* [`MessageListHeaderView`](03-message-list-header.mdx): Displays a navigation icon, the name of the channel or thread and the channel avatar.
...
* [`MessageComposerView`](04-message-composer.mdx): Allows users to participate in the chat by sending messages and attachments.

:::note
Fragments and Activities representing self-contained screens are easy to use. They allow you to explore the SDKs features in a breeze, however, they offer limited customization.
:::
