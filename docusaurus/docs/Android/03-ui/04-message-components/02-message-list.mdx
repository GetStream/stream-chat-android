...
This section lists only some of the more important handlers, many more exist and you can find there inside [`MessageListView`](https://github.com/GetStream/stream-chat-android/blob/main/stream-chat-android-ui-components/src/main/kotlin/io/getstream/chat/android/ui/feature/messages/MessageListFragment.kt).
...
| ![message_list_show_avatar_predicate_default](../../assets/message_list_show_avatar_predicate_default.png) |
|---|
...
| ![message_list_show_avatar_predicate_custom](../../assets/message_list_show_avatar_predicate_custom.png) |
|---|
