...
If the built-in [Message Input View](../05-components/07-message-input.mdx) and its available customization options don't fit your app's needs, you can create an Input View of your own.
...
Stream allows users to edit existing messages. By default, this can be triggered from the [Message List component](../05-components/05-message-list.mdx), by long tapping a message to access various actions.
