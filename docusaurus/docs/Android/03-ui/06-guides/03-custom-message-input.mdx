...
If the built-in [Message Input View](../04-message-components/04-message-composer.mdx) and its available customization options don't fit your app's needs, you can create an Input View of your own.
