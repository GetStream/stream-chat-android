...
The file containing `MessageComposerView` can be found [here](https://github.com/GetStream/stream-chat-android/blob/main/stream-chat-android-ui-components/src/main/kotlin/io/getstream/chat/android/ui/message/composer/MessageComposerView.kt).
...
![MessageComposerView with empty capabilities](../../assets/own_capabilities_message_composer_view_empty_capabilities.png)
...
![MessageComposerView with custom capabilities](../../assets/own_capabilities_message_composer_view_with_capabilities.png)
