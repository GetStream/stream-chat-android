...
![MessageComposerView with empty capabilities](../../assets/own_capabilities_message_input_view_empty_capabilities.png)
...
![MessageComposerView with custom capabilities](../../assets/own_capabilities_message_input_view_with_capabilities.png)
