...
* **Step 2**: You customize the `MessageComposer` using a set of `Modifier`s to make it fill the width and wrap the height, as well as align it to the center of the parent.
...
<!-- TODO WIP PAGE If you want a completely custom UI for the composer with custom behavior, please read our [Creating a Custom Message Input](../_07-guides/03-custom-message-input.mdx) guide.-->
