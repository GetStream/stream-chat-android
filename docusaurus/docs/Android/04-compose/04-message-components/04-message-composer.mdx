...
Compose Message Composer doc changes!
...
<!-- TODO WIP PAGE If you want a completely custom UI for the composer with custom behavior, please read our [Creating a Custom Message Input](../07-guides/03-custom-message-input.mdx) guide.-->
