...
* [`SelectedMessageMenu`](./06-selected-message-menu.mdx): Shown when the user long taps and selects a message. Allows the user to react to messages and perform different actions, like deleting, editing, replying, starting a thread and more.
...
* `showHeader`: Control whether to show the messages header or not.
