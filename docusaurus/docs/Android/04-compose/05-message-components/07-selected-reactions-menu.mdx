...
The component shows tha available reactions from the [`ChatTheme`](../03-general-customization/01-chat-theme.mdx) on the top, followed by a list of message reactions.
