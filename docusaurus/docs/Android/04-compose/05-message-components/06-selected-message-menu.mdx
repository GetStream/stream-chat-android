...
fun SelectedMessageMenu(
    ...
    reactionTypes: Map<String, ReactionIcon> = ChatTheme.reactionTypes,
...
* `reactionTypes`: Allows you customize which reactions show in the overlay. By default it uses `ChatTheme.reactionTypes` that is exposed by the [`ChatTheme`](../03-general-customization/01-chat-theme.mdx) component.

If you want to customize these options or reactions, you can set up custom reactions, using [`ChatTheme`](../03-general-customization/01-chat-theme.mdx)'s `reactionTypes` parameter.
...
| Light | Dark |
|---|---|
| ![Stylised SelectedMessageMenu component with a custom headerContent](../../assets/compose_selected_message_menu_custom_header_slot.png) | ![Stylised SelectedMessageMenu component with a custom headerContent dark](../../assets/compose_selected_message_menu_custom_header_slot_dark.png) |
