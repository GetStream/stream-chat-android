...
* `connectionState`: The state of WebSocket connection, used to switch between the title and the the `NetworkLoadingView`.
...
<!-- TODO WIP PAGE You can also choose to build a completely custom header and integrate with the rest of our components. To learn how to do that, read our [Building Custom Screens](../_07-guides/06-building-custom-screens.mdx) guide. -->
