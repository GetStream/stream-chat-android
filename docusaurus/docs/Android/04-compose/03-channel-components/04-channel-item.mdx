...
:::note
The `ChannelItem` is great if you want the default UI or replace specific slots, however, you can still completely override the `itemContent` parameter of the `ChannelList`, if you need even more custom UI.
:::
