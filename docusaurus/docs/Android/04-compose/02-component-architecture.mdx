...
| Channel List (Light & Dark Theme) | Channel List with Open Channel Menu (Light & Dark Theme) |
|---|---|
...
![The SearchInput](../assets/compose_default_search_input_component.png)
