...
Next, you'll need to create a custom messages screen that makes use of the custom message composer that you've created above:
...
1. Use our newly created `CustomMessageComposer` in our custom messages screen.
...
Finally, you need to generate a string representation of the attachment:
