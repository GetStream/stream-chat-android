...
found [here](https://github.com/GetStream/stream-chat-android/blob/0f1f54e912baf7a7284d9a4d1435fb6743aa9c78/stream-chat-android-ui-common/src/main/kotlin/io/getstream/chat/android/common/composer/MessageComposerState.kt#L39).
...
This leaves the user unable to do any actions enabled by the composer.
...
If we were to enable to user to send messages, links and attachments, we would build a set as follows:
...
And results in the `MessageComposer` having the following appearance:

![MessageComposer with empty capabilities](../../assets/own_capabilities_message_composer_with_capabilities.png)
