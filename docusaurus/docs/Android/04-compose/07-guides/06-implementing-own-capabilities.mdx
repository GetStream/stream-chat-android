...
```
The file containing `MessageComposerState` can be found [here](https://github.com/GetStream/stream-chat-android/blob/main/stream-chat-android-ui-common/src/main/kotlin/io/getstream/chat/android/common/composer/MessageComposerState.kt).
...
If you were to enable the user to send messages, links and attachments and typing events, you would build a set as follows:
