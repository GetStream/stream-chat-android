...
import channels_light from '../assets/compose_channels_screen_example.png'
import messages_light from '../assets/compose_messages_screen_example.png'
import channels_dark from '../assets/compose_channels_screen_example_dark.png'
import messages_dark from '../assets/compose_messages_screen_example_dark.png'
...
<ImageShowcase items={[
  { image: channels_light, caption: 'Channels' },
  { image: messages_light, caption: 'Messages' }
]} />
...
* [Channel Info](03-channel-components/05-channel-info.mdx)
...
<ImageShowcase items={[
  { image: channels_dark, caption: 'Channels' },
  { image: messages_dark, caption: 'Messages' }
]} />
