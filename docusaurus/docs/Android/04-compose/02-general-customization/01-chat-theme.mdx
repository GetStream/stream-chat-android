...
`StreamAttachmentFactories` provides default factories for uploads, links, both Giphy and regular images and files.
...
Used for defining reactions the user can add to messages. Provides five basic reactions out of the box.
