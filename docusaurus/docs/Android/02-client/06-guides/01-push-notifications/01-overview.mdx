...
Now that you've created a custom handler, you need to pass it into the `ChatClient.Builder`:
...
Finally, once you're done, pass in the `ChatNotificationHandler` into the `ChatClient.Builder`:
