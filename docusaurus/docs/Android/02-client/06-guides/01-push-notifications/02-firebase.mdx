...
Navigate to the **Service Accounts** tab. On **Firebase Admin SDK** section, generate a new private key. It will generate a _json_ file with the Firebase Credentials.
...
Scroll down and enable the **Firebase** switch. Paste the content of the _json_ file with the Firebase Credentials that you downloaded on the previous step, and click **Save** to confirm your changes.
