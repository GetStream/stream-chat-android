# Agora: Video Integration Guide for Android
...
## Introduction
Video calls have become immensely popular since the onset of the pandemic. Today, we take a look at how you can use the service of agora to integrate video calls into the Stream Chat SDK.
