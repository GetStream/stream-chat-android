...
In order to keep the core SDK size smaller the `OfflinePlugin` is published as a separate library and needs to be configured as described on the [Getting Started](../../01-basics/04-getting-started.mdx#adding-offline-support) page:
