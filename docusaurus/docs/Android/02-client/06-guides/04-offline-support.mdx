...
We strongly recommend using offline support as it improves user experience a lot, but on the other hand, some types of applications (e.g. focused on livestreaming) don't require it. <br/>
