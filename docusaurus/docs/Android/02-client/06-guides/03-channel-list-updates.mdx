...
You can find more details about the result class [here](https://github.com/GetStream/stream-chat-android/blob/develop/stream-chat-android-state/src/main/java/io/getstream/chat/android/offline/event/handler/chat/ChatEventHandler.kt#L50).
