...
Set up an account for 100ms
Stream Dashboard integration
Configure Dependencies
Implement VideoCallViewModel
Implement a Video Call Screen
Implement Custom Call Messages Using Custom Attachment
...
Before you dive in, you need to configure the dependencies. First, add the codes below to your root `settings.gradle` at the end of the `respositories closure`:
