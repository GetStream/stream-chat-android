...
To render a custom attachment in the [MessageListView](../message-components/message-list.mdx) you'll have to implement the `AttachmentFactory` interface:
...
To render a custom quoted attachment in the [MessageListView](../message-components/message-list.mdx) you'll have to implement the `QuotedAttachmentFactory` interface:
