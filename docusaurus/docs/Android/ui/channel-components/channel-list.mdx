...
You may need to pass a custom `ChatEventHandler` to make sure the list is updated properly. Check [ChannelListUpdates](../../client/guides/channel-list-updates.mdx) section to read more.
:::
