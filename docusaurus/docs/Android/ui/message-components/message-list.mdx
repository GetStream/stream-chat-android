...
To apply them, include them in your app's theme. You can find out more about theming in the [Theming documentation page](../general-customization/theming.mdx).
