...
:::warning
These builds should never be used in production.
:::

To use snapshot builds, you need to add the Sonatype snapshot repository in your Gradle build configuration: 
...
You can browse our available snapshot builds [here](https://oss.sonatype.org/content/repositories/snapshots/io/getstream/). 
