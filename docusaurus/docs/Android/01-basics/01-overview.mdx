...
The state library is a plugin that gives you the possibility to reactively observe data through `StateFlow`s.
...
See [State](../02-client/06-guides/04-offline-support.mdx) for more details.
