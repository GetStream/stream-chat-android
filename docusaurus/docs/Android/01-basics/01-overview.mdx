...
This plugin exposes easy-to-use StateFlow objects for reading channels, messages, reads, typing, members, watchers and more. See [Offline Support](../02-client/06-guides/04-offline-support.mdx) for more details.
