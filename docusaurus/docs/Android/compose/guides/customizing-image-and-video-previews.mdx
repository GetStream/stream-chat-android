...
The Compose UI Components chat SDK supports various types of attachments by using [attachment factories](../general-customization/attachment-factory.mdx). The one used to display image and video attachments is called `MediaAttachmentFactory` and offers a degree of customization.
...
:::note
You can read more about custom attachment factories [here](../general-customization/attachment-factory.mdx).
:::