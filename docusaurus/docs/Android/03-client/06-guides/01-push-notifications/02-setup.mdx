...
:::info
The SDK supports multiple languages. Make sure to override resources in all languages used in your app. Refer to [Adding Localization](../../../04-ui/06-guides/04-custom-translations.mdx) guide for more details.
:::
