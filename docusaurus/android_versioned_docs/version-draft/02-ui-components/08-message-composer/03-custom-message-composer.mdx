...
If the built-in [Message Composer View](/02-ui-components/08-message-composer/01-message-composer.mdx) and its available customization options don't fit your app's needs, you can create a Message Composer View of your own.
