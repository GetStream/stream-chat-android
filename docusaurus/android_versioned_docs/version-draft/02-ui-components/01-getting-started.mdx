...
- [Channel List](04-channel-list/02-channel-list.mdx)
- [Channel List Header](05-channel-list-header.mdx)

**Message components**:

- [Message List Screen](06-message-list/01-message-list-screen.mdx)
- [Message List](06-message-list/02-message-list.mdx)
- [Message List Header](07-message-list-header.mdx)
- [Message Composer](08-message-composer/01-message-composer.mdx)

**Utility components**: <!-- TODO We removed Utility components section -->
