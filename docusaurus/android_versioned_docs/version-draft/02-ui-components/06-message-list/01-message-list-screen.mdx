...
* [`MessageListHeaderView`](02-ui-components/07-message-list-header.mdx): Displays a navigation icon, the name of the channel or thread and the channel avatar.
...
* [`MessageComposerView`](02-ui-components/08-message-composer/01-message-composer.mdx): Allows users to participate in the chat by sending messages and attachments.
