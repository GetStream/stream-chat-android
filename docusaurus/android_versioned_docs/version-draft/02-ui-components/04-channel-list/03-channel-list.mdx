...
You may need to pass a custom `ChatEventHandler` to make sure the list is updated properly. Check [ChannelListUpdates](../../06-advanced/05-channel-list-updates.mdx) section to read more.
:::
