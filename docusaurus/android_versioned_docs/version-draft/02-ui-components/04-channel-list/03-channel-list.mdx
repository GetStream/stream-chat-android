...
:::note
<!-- TODO link to a guide below, section that we'll remove. What should we do? -->
You may need to pass a custom `ChatEventHandler` to make sure the list is updated properly. Check [ChannelListUpdates](../../09-client/06-guides/05-channel-list-updates.mdx) section to read more.
:::
