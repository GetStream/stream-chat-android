...
The [`ChannelListHeaderView`](02-channel-list-header.mdx) and [`ChannelListView`](03-channel-list.mdx) components work best together to display a list of channels.
