...
Our [`MessageListView`](../../../02-ui-components/06-message-list/02-message-list.mdx) UI component and [`MessageList`](../../../compose/message-components/message-list.mdx) Compose UI Component automatically dismiss notifications related to a `Channel` when the user opens it.
