...
:::info
The SDK supports multiple languages. Make sure to override resources in all languages used in your app. Refer to [Adding Localization](../../../02-ui-components/10-localization.mdx) guide for more details.
:::
...
Our [`MessageListView`](../../../02-ui-components/06-message-list/02-message-list.mdx) UI component and [`MessageList`](../../../03-compose/05-message-components/03-message-list.mdx) Compose UI Component automatically dismiss notifications related to a `Channel` when the user opens it.
