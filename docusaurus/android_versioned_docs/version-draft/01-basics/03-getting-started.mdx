...
:::note
For more information on handling complex scenarios, check out our [Handling User Connection](../09-client/06-guides/02-handling-user-connection.mdx) guide.
:::
...
For more information on working with `OfflinePlugin`, see [Offline Support](../09-client/06-guides/03-offline-support.mdx)
