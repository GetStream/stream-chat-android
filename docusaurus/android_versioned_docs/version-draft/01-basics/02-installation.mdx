...
We ship multiple artifacts to easily integrate Stream Chat with third party push notification providers. See the [Push Notification page](../09-client/06-guides/01-push-notifications/01-overview.mdx) for more details.
