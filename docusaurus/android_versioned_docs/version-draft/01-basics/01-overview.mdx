...
<!-- TODO validate list below. It's a copy from iOS, should we add/remove something? -->
- Rich-media messages
...
<!-- TODO Should we list Compose components first? -->
...
You can learn more about how state is exposed [here](../08-client/06-guides/04-state-plugin.mdx) and in the [low-level client docs](https://getstream.io/chat/docs/android/?language=kotlin).

<!-- TODO check all links on this page, especially state link above (Liviu) -->
