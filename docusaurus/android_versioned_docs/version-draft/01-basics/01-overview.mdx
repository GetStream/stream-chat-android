...
This library is built on top of the state library, and offers the quickest integration of Stream Chat into an Android application. It also offers a variety of [theming](../02-ui-components/02-general-customization/01-theming.mdx) options to make it fit your app's needs.
