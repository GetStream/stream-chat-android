...
If you're using the [`ChannelScreen`](./channels-screen.mdx) component, you don't have to do anything. The `SelectedChannelMenu` component and its logic will be integrated into the UI.
