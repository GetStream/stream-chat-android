...
You can learn more about the different component types on the [Component Architecture](../component-architecture.mdx) page.
...
:::note
You may need to pass a custom `ChatEventHandlerFactory` to the ViewModel to make sure the list is updated properly. Check [ChannelListUpdates](../../04-client/06-guides/05-channel-list-updates.mdx) section to learn more.
:::
