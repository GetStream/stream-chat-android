...
If you want to see a real world example of creating custom attachments, check out our [detailed guide on creating custom attachments](../guides/adding-custom-attachments.mdx).
