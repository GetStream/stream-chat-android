...
The Compose UI Components chat SDK supports various types of attachments by using [attachment factories](../general-customization/chat-theme.mdx#streamattachmentfactories). The one used to display image and video attachments is called `MediaAttachmentFactory` and offers a degree of customization.

:::note
Video Attachment preview thumbnails are a paid feature and as such can be turned off. You can find the pricing [here](https://getstream.io/chat/pricing/) and the information on how to turn them off in [this](../message-components/message-list.mdx#image-and-video) section.
:::
...
:::note
You can read more about custom attachment factories [here](adding-custom-attachments.mdx).
:::