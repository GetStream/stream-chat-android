...
2. Adding support for `date` attachments by creating a custom [AttachmentFactory](../general-customization/attachment-factory.mdx).
...
Let's see how to create an [AttachmentFactory](../general-customization/attachment-factory.mdx) that is capable of handling date attachments:
