...
<!-- TODO WIP PAGE If you want a completely custom UI for the composer with custom behavior, please read our Creating a Custom Message Input (../guides/04-custom-message-input.mdx) guide.-->
