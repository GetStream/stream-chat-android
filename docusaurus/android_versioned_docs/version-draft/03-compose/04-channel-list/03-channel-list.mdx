...
:::note
You may need to pass a custom `ChatEventHandlerFactory` to the ViewModel to make sure the list is updated properly. Check [ChannelListUpdates](../../09-client/06-guides/05-channel-list-updates.mdx) section to learn more.
:::
