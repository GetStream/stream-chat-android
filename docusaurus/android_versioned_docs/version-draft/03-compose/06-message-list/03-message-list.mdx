...
If you want to read more about how to customize the way these attachments are displayed, head over to the relevant section seen [here](../11-guides/02-customizing-image-and-video-previews.mdx)
