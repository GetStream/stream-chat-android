...
If you're using **screen** components, like the [`MessagesScreen`](../06-message-list/01-messages-screen.mdx), you don't have to do any setup for the `AttachmentsPicker`. If you're building custom screens, you can add the `AttachmentPicker` to the rest of your UI:
