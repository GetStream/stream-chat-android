...
* [`MessagesScreen`](06-message-list/01-messages-screen.mdx): Builds a full chat experience with a header that shows information about the channel, list that supports messages (including attachments, reactions, replies, threads and more) and a message composer that lets you write messages and send attachments.
...
You can learn more about [`ChannelsScreen`](04-channel-list/01-channels-screen.mdx) and [`MessagesScreen`](06-message-list/01-messages-screen.mdx) on their respective pages.
