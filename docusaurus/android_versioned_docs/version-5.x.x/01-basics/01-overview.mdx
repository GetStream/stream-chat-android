...
* [Client](https://github.com/GetStream/stream-chat-android/tree/v5/stream-chat-android-client)
* [Offline support](https://github.com/GetStream/stream-chat-android/tree/v5/stream-chat-android-offline)
* [UI components](https://github.com/GetStream/stream-chat-android/tree/v5/stream-chat-android-ui-components)
* [Compose UI components](https://github.com/GetStream/stream-chat-android/tree/v5/stream-chat-android-compose)
...
You can see the UI Components in action by checking out the [UI Components Sample App](https://github.com/GetStream/stream-chat-android/tree/v5/stream-chat-android-ui-components-sample), available in the GitHub repository.
...
Check out the Compose implementation in action by trying the open-source [Compose UI Components Sample App](https://github.com/GetStream/stream-chat-android/tree/v5/stream-chat-android-compose-sample).
