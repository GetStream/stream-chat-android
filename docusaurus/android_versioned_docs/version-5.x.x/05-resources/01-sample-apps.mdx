...
- [Compose UI Components Sample App](https://github.com/GetStream/stream-chat-android/tree/v5/stream-chat-android-compose-sample): The sample app built on top of our [Compose UI components](https://github.com/GetStream/stream-chat-android/tree/v5/stream-chat-android-compose) SDK.
- [UI Components Sample App](https://github.com/GetStream/stream-chat-android/tree/v5/stream-chat-android-ui-components-sample): The sample app built on top of our [UI components](https://github.com/GetStream/stream-chat-android/tree/v5/stream-chat-android-ui-components) SDK.
