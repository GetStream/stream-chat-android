...
<!-- TODO WIP PAGE You can also choose to build a completely custom header and integrate it with the rest of our components. To learn how to do that, read our Building Custom Screens (../07-guides/05-_05-building-custom-screens.mdx) guide. -->
