...
<!-- TODO WIP PAGE If you want a completely custom UI for the composer with custom behavior, please read our Creating a Custom Message Input (../07-guides/04-04-custom-message-input.mdx) guide.-->
