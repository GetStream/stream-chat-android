...
2. Adding support for `date` attachments by creating a custom [AttachmentFactory](../../04-compose/03-general-customization/02-attachment-factory.mdx).
...
You can find the full code from this guide on [GitHub](https://github.com/GetStream/stream-chat-android/tree/v5/stream-chat-android-ui-guides/src/main/java/io/getstream/chat/android/guides/catalog/compose/customattachments). To check the final result, clone the repository, select the `stream-chat-android-ui-guides` module on your Android Studio like the image below, and run the module. ![UI Guides Module on Android Studio](../../assets/ui_guides_module_android_studio.png)
:::
