...
public class VideoView extends RelativeLayout {
    ...
    protected class AttributeContainer {
         ...
         * then the default value from the {@link com.getstream.sdk.chat.utils.exomedia.core.video.scale.MatrixManager}
         * will be used.
         */
        @Nullable
         ...
         * the default value is different between the {@link com.getstream.sdk.chat.utils.exomedia.core.video.ResizingSurfaceView}
         * and {@link com.getstream.sdk.chat.utils.exomedia.core.video.ResizingTextureView} this will be <code>null</code>
         * when not specified.
         */
        @Nullable
        ...
        public AttributeContainer(@NonNull Context context, @Nullable AttributeSet attrs) {
            ...
            useDefaultControls = typedArray.getBoolean(R.styleable.VideoView_stream_useDefaultControls, useDefaultControls);
            useTextureViewBacking = typedArray.getBoolean(R.styleable.VideoView_stream_useTextureViewBacking, useTextureViewBacking);

            if (typedArray.hasValue(R.styleable.VideoView_stream_videoScale)) {
                scaleType = ScaleType.fromOrdinal(typedArray.getInt(R.styleable.VideoView_stream_videoScale, -1));
            }

            if (typedArray.hasValue(R.styleable.VideoView_stream_measureBasedOnAspectRatio)) {
                measureBasedOnAspectRatio = typedArray.getBoolean(R.styleable.VideoView_stream_measureBasedOnAspectRatio, false);
            }
            ...
            apiImplResourceId = typedArray.getResourceId(R.styleable.VideoView_stream_videoViewApiImpl, apiImplResourceId);
            apiImplLegacyResourceId = typedArray.getResourceId(R.styleable.VideoView_stream_videoViewApiImplLegacy, apiImplLegacyResourceId);
