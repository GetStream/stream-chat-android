 ...
 * @param visualMediaAllowMultiple If true, multiple visual media items can be selected. Default is true.
 ...
 * @param filesAllowMultiple If true, multiple files can be selected. Default is true.
...
public data class SystemAttachmentsPickerConfig(
    ...
    public val visualMediaAllowMultiple: Boolean = true,
    ...
    public val filesAllowMultiple: Boolean = true,
