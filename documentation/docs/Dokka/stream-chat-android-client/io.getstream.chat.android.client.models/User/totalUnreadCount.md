...
# totalUnreadCount  
@SerializedName(value = total_unread_count)var [totalUnreadCount](totalUnreadCount.md): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html) = 0
