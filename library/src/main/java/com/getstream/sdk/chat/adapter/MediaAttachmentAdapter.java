...
public class MediaAttachmentAdapter extends RecyclerView.Adapter<MediaAttachmentAdapter.MyViewHolder> {
    ...
    private List<UploadAttachment> mediaPaths;
    public MediaAttachmentAdapter(Context context, List<UploadAttachment> mediaPaths, OnItemClickListener listener) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(UploadAttachment attachment, final OnItemClickListener listener) {
