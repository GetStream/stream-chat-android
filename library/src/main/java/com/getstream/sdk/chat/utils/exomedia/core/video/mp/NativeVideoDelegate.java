...
public class NativeVideoDelegate {
    ...
    public void stopPlayback(boolean clearSurface) {
        ...
        if (isReady()) {
            try {
                ...
                StreamChat.logD(this.getClass(),"stopPlayback: error calling mediaPlayer.stop(), Error:" + e);
            }
        }
    ...
    public void suspend() {
        ...
        try {
            ...
            StreamChat.logD(this.getClass(),"stopPlayback: error calling mediaPlayer.reset() or mediaPlayer.release(). Error:" + e);
        }
    ...
    protected void openVideo(@Nullable Uri uri) {
        ...
        try {
            ...
            StreamChat.logW(this.getClass(), "Unable to open content: " + uri + ", " + ex);
    ...
    public class InternalListeners implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener,
        ...
        public boolean onError(MediaPlayer mp, int what, int extra) {
            StreamChat.logD(this.getClass(),"Error: " + what + "," + extra);
            currentState = State.ERROR;
