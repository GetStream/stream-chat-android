...
class MessageInputStyle(context: Context, attrs: AttributeSet?) : BaseStyle() {
    ...
    // Attachment Button
    private val prefs // Used for write/read isShowAttachmentButton from Request permissions
            : SharedPreferences
    ...
    fun getAttachmentButtonIcon(isSelected: Boolean): Drawable {
        return if (attachmentButtonIcon == -1) {
            getSelector(if (isSelected) attachmentButtonSelectedIconColor else attachmentButtonDefaultIconColor,
    ...
    fun getInputButtonIcon(isEdit: Boolean): Drawable {
        return if (inputButtonIcon == -1) {
            getSelector(if (isEdit) inputButtonEditIconColor else inputButtonDefaultIconColor, inputButtonDefaultIconPressedColor,
    ...
    init {
        ...
        context.obtainStyledAttributes(attrs, R.styleable.MessageInputView).run {
            ...
            attachmentButtonDefaultIconColor = getColor(R.styleable.MessageInputView_streamAttachmentButtonDefaultIconColor,
                    getColor(R.color.stream_gray_dark))
            attachmentButtonDefaultIconPressedColor = getColor(R.styleable.MessageInputView_streamAttachmentButtonDefaultIconPressedColor,
                    getColor(R.color.stream_white))
            attachmentButtonDefaultIconDisabledColor = getColor(R.styleable.MessageInputView_streamAttachmentButtonDefaultIconDisabledColor,
                    getColor(R.color.stream_gray_light))
            attachmentButtonSelectedIconColor = getColor(R.styleable.MessageInputView_streamAttachmentButtonDefaultIconDisabledColor,
            ...
            inputButtonDefaultIconColor = getColor(R.styleable.MessageInputView_streamInputButtonDefaultIconColor,
                    getColor(R.color.stream_input_message_send_button))
            inputButtonEditIconColor = getColor(R.styleable.MessageInputView_streamInputButtonEditIconColor,
                    getColor(R.color.stream_input_message_box_stroke_edit))
            inputButtonDefaultIconPressedColor = getColor(R.styleable.MessageInputView_streamInputButtonDefaultIconPressedColor,
                    getColor(R.color.stream_white))
            inputButtonDefaultIconDisabledColor = getColor(R.styleable.MessageInputView_streamInputButtonDefaultIconDisabledColor,
                    getColor(R.color.stream_gray_dark))
