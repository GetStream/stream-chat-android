...
public class ExoMedia {
     ...
     * instances for use with the {@link com.getstream.sdk.chat.utils.exomedia.core.source.builder.MediaSourceBuilder}s. This will
     * only be used for builders that haven't customized the {@link com.getstream.sdk.chat.utils.exomedia.core.source.builder.MediaSourceBuilder#buildDataSourceFactory(Context, String, TransferListener)}
     * method.
     *
     * @param provider The provider to use for the {@link com.getstream.sdk.chat.utils.exomedia.core.source.builder.MediaSourceBuilder}s
     ...
     * used in the {@link com.getstream.sdk.chat.utils.exomedia.ui.widget.VideoView} and {@link AudioPlayer}. This allows the
