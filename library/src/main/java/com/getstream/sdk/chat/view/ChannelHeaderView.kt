...
class ChannelHeaderView @JvmOverloads constructor(
	...
	private fun applyStyle() {
		...
		if (! style.isAvatarGroupShow) binding.ivActiveBadge.visibility = View.GONE else binding.ivActiveBadge.visibility = if (style.isActiveBadgeShow) View.VISIBLE else View.GONE
	}
}