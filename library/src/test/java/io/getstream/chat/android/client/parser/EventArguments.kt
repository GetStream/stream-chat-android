...
object EventArguments {
    ...
    private fun eventArguments() = listOf(
        ...
        Arguments.of(createChannelUnmuteEventStringJson(), ChannelUnmuteEvent::class.java, channelUnmuteEvent),
        Arguments.of(createChannelsUnmuteEventStringJson(), ChannelsUnmuteEvent::class.java, channelsUnmuteEvent),
        Arguments.of(createChannelUpdatedEventStringJson(), ChannelUpdatedEvent::class.java, channelUpdatedEvent),
        Arguments.of(createChannelVisibleEventStringJson(), ChannelVisibleEvent::class.java, channelVisibleEvent),
        Arguments.of(createMemberAddedEventStringJson(), MemberAddedEvent::class.java, memberAddedEvent),
        Arguments.of(createMemberRemovedEventStringJson(), MemberRemovedEvent::class.java, memberRemovedEvent),
        Arguments.of(createMemberUpdatedEventStringJson(), MemberUpdatedEvent::class.java, memberUpdatedEvent),
        Arguments.of(createMessageDeletedEventStringJson(), MessageDeletedEvent::class.java, messageDeletedEvent),
        Arguments.of(createMessageReadEventStringJson(), MessageReadEvent::class.java, messageReadEvent),
        Arguments.of(createMessageUpdatedEventStringJson(), MessageUpdatedEvent::class.java, messageUpdatedEvent),
        Arguments.of(createNotificationAddedToChannelEventStringJson(), NotificationAddedToChannelEvent::class.java, notificationAddedToChannelEvent),
        Arguments.of(createNotificationChannelDeletedEventStringJson(), NotificationChannelDeletedEvent::class.java, notificationChannelDeletedEvent),
        Arguments.of(createNotificationChannelTruncatedEventStringJson(), NotificationChannelTruncatedEvent::class.java, notificationChannelTruncatedEvent),
        Arguments.of(createNotificationInviteAcceptedEventStringJson(), NotificationInviteAcceptedEvent::class.java, notificationInviteAcceptedEvent),
        Arguments.of(createNotificationInvitedEventStringJson(), NotificationInvitedEvent::class.java, notificationInvitedEvent),
        Arguments.of(createNotificationMarkReadEventStringJson(), NotificationMarkReadEvent::class.java, notificationMarkReadEvent),
        Arguments.of(createNotificationMessageNewEventStringJson(), NotificationMessageNewEvent::class.java, notificationMessageNewEvent),
        Arguments.of(createNotificationRemovedFromChannelEventStringJson(), NotificationRemovedFromChannelEvent::class.java, notificationRemovedFromChannelEvent),
        Arguments.of(createReactionDeletedEventStringJson(), ReactionDeletedEvent::class.java, reactionDeletedEvent),
        Arguments.of(createReactionNewEventStringJson(), ReactionNewEvent::class.java, reactionNewEvent),
        Arguments.of(createReactionUpdateEventStringJson(), ReactionUpdateEvent::class.java, reactionUpdateEvent),
        Arguments.of(createTypingStartEventStringJson(), TypingStartEvent::class.java, typingStartEvent),
        Arguments.of(createTypingStopEventStringJson(), TypingStopEvent::class.java, typingStopEvent),
        Arguments.of(createChannelUserBannedEventStringJson(), ChannelUserBannedEvent::class.java, channelUserBannedEvent),
        Arguments.of(createGlobalUserBannedEventStringJson(), GlobalUserBannedEvent::class.java, globalUserBannedEvent),
        Arguments.of(createUserDeletedEventStringJson(), UserDeletedEvent::class.java, userDeletedEvent),
        Arguments.of(createUserMutedEventStringJson(), UserMutedEvent::class.java, userMutedEvent),
        Arguments.of(createUsersMutedEventStringJson(), UsersMutedEvent::class.java, usersMutedEvent),
        Arguments.of(createUserPresenceChangedEventStringJson(), UserPresenceChangedEvent::class.java, userPresenceChangedEvent),
        Arguments.of(createUserStartWatchingEventStringJson(), UserStartWatchingEvent::class.java, userStartWatchingEvent),
        Arguments.of(createUserStopWatchingEventStringJson(), UserStopWatchingEvent::class.java, userStopWatchingEvent),
        Arguments.of(createChannelUserUnbannedEventStringJson(), ChannelUserUnbannedEvent::class.java, channelUserUnbannedEvent),
        Arguments.of(createGlobalUserUnbannedEventStringJson(), GlobalUserUnbannedEvent::class.java, globalUserUnbannedEvent),
        Arguments.of(createUserUnmutedEventStringJson(), UserUnmutedEvent::class.java, userUnmutedEvent),
        ...
        Arguments.of(createChannelMuteEventStringJson(), ChannelMuteEvent::class.java, channelMuteEvent),
        Arguments.of(createChannelsMuteEventStringJson(), ChannelsMuteEvent::class.java, channelsMuteEvent),
