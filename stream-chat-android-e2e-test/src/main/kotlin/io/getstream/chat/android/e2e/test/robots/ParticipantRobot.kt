...
import io.getstream.chat.android.e2e.test.chat.AttachmentType
...
public class ParticipantRobot {
    ...
    public fun quoteMessage(text: String) : ParticipantRobot {
        mockServer.postRequest("/participant/message?quote=true", text.toRequestBody("text".toMediaTypeOrNull()))
        return this
    }
    ...
    public fun quoteMessageWithGiphyInThread(alsoSendInChannel: Boolean = false) : ParticipantRobot {
        mockServer.postRequest("/participant/message?giphy=true&quote=true&thread=true&thread_and_channel=$alsoSendInChannel")
        return this
    }
    ...
    public fun uploadAttachmentInThread(
        ...
        mockServer.postRequest("/participant/message?$type=$count&thread=true&thread_and_channel=$alsoSendInChannel")
        return this
    }
    ...
    public fun quoteMessageWithAttachmentInThread(
        ...
        mockServer.postRequest("/participant/message?quote=true&$type=$count&thread=true&thread_and_channel=$alsoSendInChannel")
        return this
    }
