...
data class ChatMessageResponse (
    ...
    val latestReactions: kotlin.collections.List<io.getstream.chat.android.network.models.ChatReactionResponse> = emptyList(),
    ...
    val ownReactions: kotlin.collections.List<io.getstream.chat.android.network.models.ChatReactionResponse> = emptyList(),
    ...
    @Json(name = "draft")
    val draft: io.getstream.chat.android.network.models.ChatDraftResponse? = null,
    ...
    val moderation: io.getstream.chat.android.network.models.ChatModerationV2Response? = null,
    ...
    val quotedMessage: io.getstream.chat.android.network.models.ChatMessageResponse? = null,

    @Json(name = "reaction_groups")
    val reactionGroups: kotlin.collections.Map<kotlin.String, io.getstream.chat.android.network.models.ChatReactionGroupResponse>? = emptyMap(),

    @Json(name = "reminder")
    val reminder: io.getstream.chat.android.network.models.ChatReminderResponseData? = null,

    @Json(name = "shared_location")
    val sharedLocation: io.getstream.chat.android.network.models.ChatSharedLocationResponseData? = null
)
