...
class ChatEventAdapter : JsonAdapter<ChatEvent>() {
    ...
    private fun getSubclass(type: String): Class<out ChatEvent> {
        return when (type) {
            ...
            else -> UnsupportedChatEvent::class.java
        }
    }
}

class UnsupportedChatEvent(val type: String) : ChatEvent() {
    override fun getEventType(): String {
        return type
    }
}

class UnsupportedChatEventException(val type: String) : Exception()
