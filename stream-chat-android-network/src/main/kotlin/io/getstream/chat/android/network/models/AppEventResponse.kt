...
data class AppEventResponse(
    ...
    val fileUploadConfig: io.getstream.chat.android.network.models.FileUploadConfig? = null,

    @Json(name = "image_upload_config")
    val imageUploadConfig: io.getstream.chat.android.network.models.FileUploadConfig? = null,
)
