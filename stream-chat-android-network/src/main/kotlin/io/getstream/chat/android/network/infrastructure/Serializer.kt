...
object Serializer {
    ...
    val moshiBuilder: Moshi.Builder = Moshi.Builder()
        .add(io.getstream.chat.android.network.models.AWSRekognitionRule.Action.ActionAdapter())
        .add(io.getstream.chat.android.network.models.AutomodRule.Action.ActionAdapter())
        .add(io.getstream.chat.android.network.models.AutomodSemanticFiltersRule.Action.ActionAdapter())
        .add(io.getstream.chat.android.network.models.BanActionRequestPayload.DeleteMessages.DeleteMessagesAdapter())
        .add(io.getstream.chat.android.network.models.BanOptions.DeleteMessages.DeleteMessagesAdapter())
        .add(io.getstream.chat.android.network.models.BanRequest.DeleteMessages.DeleteMessagesAdapter())
        .add(io.getstream.chat.android.network.models.BlockListOptions.Behavior.BehaviorAdapter())
        .add(io.getstream.chat.android.network.models.BlockListRule.Action.ActionAdapter())
        .add(io.getstream.chat.android.network.models.BodyguardRule.Action.ActionAdapter())
        .add(io.getstream.chat.android.network.models.BodyguardSeverityRule.Action.ActionAdapter())
        .add(io.getstream.chat.android.network.models.BodyguardSeverityRule.Severity.SeverityAdapter())
        .add(io.getstream.chat.android.network.models.BulkActionAppealsRequest.ActionType.ActionTypeAdapter())
        ...
        .add(io.getstream.chat.android.network.models.LLMRule.Action.ActionAdapter())
        .add(io.getstream.chat.android.network.models.MessageRequest.Type.TypeAdapter())
        .add(io.getstream.chat.android.network.models.OCRRule.Action.ActionAdapter())
        ...
        .add(io.getstream.chat.android.network.models.RuleBuilderAction.Type.TypeAdapter())
        .add(io.getstream.chat.android.network.models.SubmitActionRequest.ActionType.ActionTypeAdapter())
        ...
        .add(io.getstream.chat.android.network.models.VelocityFilterConfigRule.Action.ActionAdapter())
        .add(io.getstream.chat.android.network.models.VelocityFilterConfigRule.CascadingAction.CascadingActionAdapter())
        ...
        .add(io.getstream.chat.android.network.infrastructure.OffsetDateTimeAdapter())
        .add(io.getstream.chat.android.network.infrastructure.LocalDateAdapter())
        .add(io.getstream.chat.android.network.infrastructure.LocalDateTimeAdapter())
