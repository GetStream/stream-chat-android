...
class WSClientEventAdapter : JsonAdapter<WSClientEvent>() {

    @FromJson
    override fun fromJson(reader: JsonReader): WSClientEvent? {
    ...
    @ToJson
    override fun toJson(writer: JsonWriter, value: WSClientEvent?) {
        throw UnsupportedOperationException("toJson not implemented")
    }

    private fun getSubclass(type: String): Class<out WSClientEvent> {
        return when (type) {
            ...
            else -> UnsupportedWSClientEvent::class.java       
        }
    }
}

class UnsupportedWSClientEvent(val type: String) : WSClientEvent() {
    override fun getEventType(): String {
        return type
    }
}

class UnsupportedWSClientEventException(val type: String) : Exception()
