...
data class ModerationCustomActionEvent (
    ...
    val reviewQueueItem: io.getstream.chat.android.network.models.ReviewQueueItemResponse,
    ...
    val actionOptions: kotlin.collections.Map<kotlin.String, Any?>? = emptyMap(),
