...
/**
 * Represents the information about the last message for the channel item,
 * such as its read state and how many unread messages the user has.
 *
...
/**
 * Preview of [ChannelLastMessageInfo].
 *
...
@Composable
private fun ChannelLastMessageInfoPreview() {
    ChatTheme {
