...
/**
 * ViewModel for managing poll option results state in Compose UI components.
 *
...
public class PollOptionResultsViewModel(
     ...
     */
    public val state: StateFlow<PollOptionResultsViewState> = controller.state

    /**
     * @see [PollOptionResultsViewController.events]
     */
    public val events: SharedFlow<PollOptionResultsViewEvent> = controller.events
