...
internal fun ToggleableTranslatedLabel(
    ...
    if (messageItem.message.showOriginalText) {
        ShowTranslationLabel(onToggleOriginalText = { messageItem.onToggleOriginalText(messageItem.message) })
    } else {
        Row {
            TranslatedLabel(translatedTo)
            ShowOriginalLabel(onToggleOriginalText = { messageItem.onToggleOriginalText(messageItem.message) })
        }
    }
}
