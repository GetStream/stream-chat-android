 ...
 * @param maxVotesPerPerson Configuration for the "limit votes per person" toggle (child of "multiple votes").
...
public data class PollsConfig(
    ...
    val maxVotesPerPerson: PollFeatureConfig = PollFeatureConfig(),
