...
@Composable
public fun MessageReactionsMenu(
    message: Message,
    currentUser: User?,
    ...
    ModalBottomSheet(
        ...
        ChatTheme.componentFactory.MessageReactionsMenuContent(
 ...
 */
@Composable
public fun MessageReactionsMenuContent(
    message: Message,
    currentUser: User?,
    ownCapabilities: Set<String>,
    onMessageAction: (MessageAction) -> Unit,
...
/**
 * Preview of the [MessageReactionsMenu] component with 1 reaction.
 */
@Preview
@Composable
...
/**
 * Preview of the [MessageReactionsMenu] component with many reactions.
 */
@Preview
@Composable
