...
public fun DefaultMessageItem(
    ...
    systemMessageContent: @Composable (SystemMessageItem) -> Unit = {
        SystemMessage(
            modifier = Modifier
                .fillMaxWidth()
    ...
    when (messageListItem) {
        ...
        is SystemMessageItem -> systemMessageContent(messageListItem)
 ...
 *
 * @param systemMessageItem The system message item to show.
 * @param modifier Modifier for styling.
 */
@Composable
