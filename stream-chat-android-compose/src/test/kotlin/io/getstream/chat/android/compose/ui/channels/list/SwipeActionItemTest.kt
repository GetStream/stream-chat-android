...
internal class SwipeActionItemTest : PaparazziComposeTest {
    ...
    fun `swipe action item styles`() {
        snapshotWithDarkMode {
            Row(modifier = Modifier.height(72.dp)) {
                ...
                SwipeActionItem(
                    icon = painterResource(R.drawable.stream_design_ic_mute),
                    label = "Mute",
                    onClick = {},
                    style = SwipeActionStyle.Primary,
                )
                SwipeActionItem(
                    icon = painterResource(R.drawable.stream_design_ic_delete),
                    label = "Delete",
                    onClick = {},
