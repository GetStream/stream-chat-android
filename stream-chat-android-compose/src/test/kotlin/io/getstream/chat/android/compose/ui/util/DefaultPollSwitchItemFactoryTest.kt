...
internal class DefaultPollSwitchItemFactoryTest {
    ...
    fun testDefaultPollSwitchItemFactory() {
        ...
        whenever(context.getString(R.string.stream_compose_poll_option_switch_multiple_answers_description))
            .thenReturn("Select more than one option")
        ...
        whenever(context.getString(R.string.stream_compose_poll_option_switch_anonymous_poll_description))
            .thenReturn("Hide who voted")
        whenever(context.getString(R.string.stream_compose_poll_option_switch_suggest_option))
            .thenReturn("Suggest an option")
        whenever(context.getString(R.string.stream_compose_poll_option_switch_suggest_option_description))
            .thenReturn("Let others add options")
        whenever(context.getString(R.string.stream_compose_poll_option_switch_add_comment))
            .thenReturn("Add a comment")
        whenever(context.getString(R.string.stream_compose_poll_option_switch_add_comment_description))
            .thenReturn("Allow others to add comments")
        // when
        ...
        assertEquals("Select more than one option", items[0].description)
        ...
        assertEquals("Hide who voted", items[1].description)
        ...
        assertEquals("Let others add options", items[2].description)
        ...
        assertEquals("Allow others to add comments", items[3].description)
