...
internal class ThreadListHeaderTest : PaparazziComposeTest {
    ...
    fun `connected, no user`() {
        snapshotWithDarkMode {
            ThreadListHeaderConnectedNoUser()
        }
    }
    ...
    fun `connecting, no user`() {
        snapshotWithDarkMode {
            ThreadListHeaderConnectingNoUser()
        }
    }
    ...
    fun `offline, with user`() {
        snapshotWithDarkMode {
            ThreadListHeaderOfflineWithUser()
        }
    }
}
