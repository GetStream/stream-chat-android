...
internal class ChannelAttachmentsViewModelFactoryTest {

    @Test
    fun `create should return correct instance`() {
        val sut = Fixture().get()

        val viewModel = sut.create(ChannelAttachmentsViewModel::class.java)

        assertInstanceOf<ChannelAttachmentsViewModel>(viewModel)
    }
    ...
    private class Fixture {
        fun get() = ChannelAttachmentsViewModelFactory(
            cid = randomCID(),
