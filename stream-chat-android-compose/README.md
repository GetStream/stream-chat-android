...
This module contains reusable UI components built in Jetpack Compose. See the [Compose UI Components documentation](https://getstream.io/chat/docs/sdk/android/compose/overview/) for more info.
