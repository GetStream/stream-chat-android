 ...
 *
 * Use this class to style SuggestionListView programmatically. You can pass this class to
 * [TransformStyle.suggestionListStyleTransformer]
 ...
 * @property commandsTitleTextStyle Sets the styles for title for the commands box. Use to customise size, colour,
 * font and style (ex: bold).
 * @property commandsNameTextStyle Sets the styles for the name of the command in the command list. Use to customise
 * size, colour, font and style (ex: bold)
 * @property commandsDescriptionTextStyle Sets the styles for the description of the command in the command list.
 * Use to customise size, colour, font and style (ex: bold).
 ...
 * @property lightningIcon Icon to the left of command list title. Default value is
 * [R.drawable.stream_ui_ic_command_blue].
 */
