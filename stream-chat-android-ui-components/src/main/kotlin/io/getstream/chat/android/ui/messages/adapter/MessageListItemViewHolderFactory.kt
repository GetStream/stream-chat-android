...
public open class MessageListItemViewHolderFactory {
    ...
    public open fun createDateDividerViewHolder(parentView: View): BaseMessageItemViewHolder<*> =
        createBaseMessageItemViewHolder(parentView)

    public open fun createTypingIndicatorViewHolder(parentView: View): BaseMessageItemViewHolder<*> =
        createBaseMessageItemViewHolder(parentView)

    public open fun createMessageDeletedViewHolder(parentView: View): BaseMessageItemViewHolder<*> =
        createBaseMessageItemViewHolder(parentView)

    public open fun createPlainTextViewHolder(parentView: View): BaseMessageItemViewHolder<*> =
        createBaseMessageItemViewHolder(parentView)

    public open fun createReplyMessageViewHolder(parentView: View): BaseMessageItemViewHolder<*> =
        createBaseMessageItemViewHolder(parentView)

    public open fun createPlainTextWithAttachmentsViewHolder(parentView: View): BaseMessageItemViewHolder<*> =
        createBaseMessageItemViewHolder(parentView)

    public open fun createAttachmentsViewHolder(parentView: View): BaseMessageItemViewHolder<*> =
        createBaseMessageItemViewHolder(parentView)

    public open fun createLoadingIndicatorViewHolder(parentView: View): BaseMessageItemViewHolder<*> =
        createBaseMessageItemViewHolder(parentView)

    public open fun createThreadSeparatorViewHolder(parentView: View): BaseMessageItemViewHolder<*> =
        createBaseMessageItemViewHolder(parentView)
