...
package io.getstream.chat.android.ui.channel.list.viewmodel.v2
...
import io.getstream.chat.android.ui.channel.list.viewmodel.ChannelListViewModel.ErrorEvent as ErrorEventV1
...
public fun ChannelListViewModel.bindView(
    ...
    fun ChannelListViewModel.ErrorEvent.toV1(): ErrorEventV1 = when (this) {
        is ChannelListViewModel.ErrorEvent.DeleteChannelError -> ErrorEventV1.DeleteChannelError(chatError)
        is ChannelListViewModel.ErrorEvent.HideChannelError -> ErrorEventV1.HideChannelError(chatError)
        is ChannelListViewModel.ErrorEvent.LeaveChannelError -> ErrorEventV1.LeaveChannelError(chatError)
    }
