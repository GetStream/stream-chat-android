...
internal fun ellipsizeText(text: String, textLimit: Int, maxLineBreaks: Int = MAX_LINE_BREAKS): String = when {
...
private fun textIsTooTall(text: String, maxLineBreaks: Int): Boolean = text.count { char -> char == '\n' } > maxLineBreaks
