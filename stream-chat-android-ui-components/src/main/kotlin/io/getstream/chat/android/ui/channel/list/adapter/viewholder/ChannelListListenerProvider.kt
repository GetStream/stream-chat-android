...
public class ChannelListListenerProvider(
    ...
    public var channelLongClickListener: ChannelListView.ChannelClickListener by ListenerDelegate(channelLongClickListener) { getListener ->
        ChannelListView.ChannelClickListener { channel ->
            getListener().onClick(channel)
        }
    }
    ...
    public var moreOptionsClickListener: ChannelListView.ChannelClickListener by ListenerDelegate(moreOptionsClickListener) { getListener ->
        ChannelListView.ChannelClickListener { channel ->
            getListener().onClick(channel)
        }
    }
