...
public class ChannelListViewModelFactory @JvmOverloads constructor(
    ...
    private val sort: IQuerySort<Channel> = ChannelListViewModel.DEFAULT_SORT,
    ...
    public class Builder @SinceKotlin("99999.9") constructor() {
        ...
        private var sort: IQuerySort<Channel> = ChannelListViewModel.DEFAULT_SORT
         ...
         */
        public fun sort(sort: IQuerySort<Channel>): Builder = apply {
            this.sort = sort
        }
