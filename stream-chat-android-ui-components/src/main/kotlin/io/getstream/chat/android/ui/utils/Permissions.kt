 ...
 */
internal fun Context.wasPermissionRequested(permission: String): Boolean {
 ...
 */
internal fun Context.onPermissionRequested(permission: String) {
    return getSharedPreferences(PERMISSIONS_PREFS, Context.MODE_PRIVATE).edit().putBoolean(permission, true).apply()
}

internal const val PERMISSIONS_PREFS = "stream_permissions"
