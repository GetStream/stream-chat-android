@file:JvmName("MessagesHeaderViewModelBinding")
...
/**
 * Binds [MessagesHeaderView] with [MessagesHeaderViewModel], updating the view's state
 * based on data provided by the ViewModel.
 */
@JvmName("bind")
public fun MessagesHeaderViewModel.bindView(view: MessagesHeaderView, lifecycle: LifecycleOwner) {
